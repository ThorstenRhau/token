...
---@alias token.OnColors fun(colors: token.Palette, background: 'dark'|'light', colorscheme: 'token'|'token-flint')

---Callback invoked after highlight overrides and before global attribute gates.
---@alias token.OnHighlights fun(highlights: token.HighlightMap, colors: token.Palette, background: 'dark'|'light', colorscheme: 'token'|'token-flint')
